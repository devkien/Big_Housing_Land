    ...
    <div class="app-container" style="background: white;">
        ...
        <div class="info-grid">
            ...
            <div style="display:flex; flex-direction:column; align-items:flex-end;">
                <?php if (!empty($user['anh_cccd'])):
                    $ccdUrl = rtrim(BASE_URL, '/') . '/uploads/' . ltrim($user['anh_cccd'], '/'); ?>
                    <img src="<?php echo htmlspecialchars($ccdUrl, ENT_QUOTES, 'UTF-8'); ?>" class="id-card-img" alt="CCCD" style="background:#eee;">
                <?php else: ?>
                    <img src="<?php echo rtrim(BASE_URL, '/') . '/img/cmnd.png'; ?>" class="id-card-img" alt="CCCD" style="background:#eee;">
                <?php endif; ?>
                <div class="id-number-caption"><i class="fa-regular fa-id-card"></i> <?php echo htmlspecialchars($user['so_cccd'] ?? ''); ?></div>
            </div>
        </div>
        ...
        <div class="filter-bar">
            ...
            <div class="filter-btn-box">
                Khách cần mua gấp <i class="fa-solid fa-arrow-down-up"></i>
            </div>
        </div>
