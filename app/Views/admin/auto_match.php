...
<body>
    <div class="app-container" style="background: white;">
        ...
        <form id="filter-container" style="padding: 15px;" method="POST" action="<?= BASE_URL ?>/admin/auto-match">
            ...
            <div id="post-list-container" style="padding-bottom: 80px;">
                ...
                <?php else: ?>
                    <?php foreach ($properties as $p): ?>
                        ...
                        ?>
                        <article class="post-card" onclick="window.location.href='<?= BASE_URL ?>/admin/detail?id=<?= (int)$p['id'] ?>'">
