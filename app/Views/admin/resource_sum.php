...
<body>
    <div class="app-container" style="background: white;">
        ...
        <div class="tabs-container">
            ...
            <button class="tab-btn inactive" onclick="window.location.href='<?= BASE_URL ?>/admin/management-resource-sum_2'">Kho nhà cho thuê</button>
        ...
        <div class="pagination-container">
            ...
            <?php if ($page > 1): ?>
                <a href="<?= BASE_URL ?>/admin/management-resource-sum?page=<?= $page - 1 ?>&<?= $queryString ?>" class="page-link"><i class="fa-solid fa-chevron-left"></i></a>
            <?php endif; ?>
            
            <a href="#" class="page-link active"><?= $page ?> / <?= $pages > 0 ? $pages : 1 ?></a>
            
            <?php if ($page < $pages): ?>
                <a href="<?= BASE_URL ?>/admin/management-resource-sum?page=<?= $page + 1 ?>&<?= $queryString ?>" class="page-link"><i class="fa-solid fa-chevron-right"></i></a>
            <?php endif; ?>
        </div>
        <!-- Modal Lọc -->
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (applyFilter) {
                applyFilter.addEventListener('click', () => {
                    ...
                    const url = new URL('<?= BASE_URL ?>/admin/management-resource-sum', window.location.origin);
