...
<head>
    ...
    <style>
        ...
        .img-wrap img, .img-wrap video { width: 100px; height: 100px; object-fit: cover; border-radius: 4px; }
        .img-delete-btn { position: absolute; top: -5px; right: -5px; background: #ff3333; color: white; border: none; border-radius: 50%; width: 20px; height: 20px; cursor: pointer; display: flex; align-items: center; justify-content: center; font-size: 12px; }
        .img-wrap.marked-for-delete img { opacity: 0.5; border: 2px solid #ff3333; }
    </style>
</head>
<body>
    ...
    <script>
        ...
        ClassicEditor
            .create(document.querySelector('#editor-notify-content'), {
                toolbar: { items: ['heading', '|', 'bold', 'italic', 'underline', '|', 'bulletedList', 'numberedList', '|', 'undo', 'redo'] },
